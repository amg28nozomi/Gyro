...
namespace {
  ...
  constexpr auto ExciteTrickActive = "GyroExciteTrickActive";  //!< 必殺技構え
  constexpr auto ExciteTrick1 = "GyroExciteTrickDirect1";      //!< 必殺技中
  constexpr auto ExciteTrick2 = "GyroExciteTrickDirect2";      //!< 必殺技後
